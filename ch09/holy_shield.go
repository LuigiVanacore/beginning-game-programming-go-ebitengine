...
// NewHolyShieldWeapon builds the Holy Shield; add to player.WeaponsRoot with AddChildren.
func NewHolyShieldWeapon(engine *Engine, player *Player, radius float64) *HolyShieldWeapon {
	...
	col.SetPosition(0, 0)
	sprite := NewSprite("holy_shield_sprite", newHolyShieldCircleImage(radius), 0, true)
