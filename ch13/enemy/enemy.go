...
const (
	...
	// HitFlashDuration is how many frames an enemy flashes white after a hit (ch13).
	HitFlashDuration = 4
)
...
type Enemy struct {
	...
	HitFlashFrames int // counts down while the enemy flashes white after a hit (ch13)
}
...
func (e *Enemy) TakeDamage(amount float64) {
	...
	e.HitFlashFrames = HitFlashDuration // trigger the white hit flash
}
