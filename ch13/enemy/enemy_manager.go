...
import . "book/code/ch13/internal/core"
...
// Enemies returns the active enemy list. The renderer reads it to draw per-enemy
// effects such as the hit flash (ch13); callers must not mutate the slice.
func (m *EnemyManager) Enemies() []*Enemy { return m.enemies }
