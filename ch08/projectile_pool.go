...
const (
	...
	// ProjectilePoolSize is the default pre-allocated projectile slot count for NewProjectilePool.
...
// Acquire takes a projectile from the pool, configures it, and adds it to the world.
...
func (p *ProjectilePool) Acquire(
	...
	proj.reset(spawnX, spawnY, vx, vy)
