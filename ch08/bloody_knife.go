...
// BloodyKnifeWeapon manages the pool, cooldown, and active projectiles; it embeds Node2D as the weapon's logical root (Ch8).
...
// UpdateProjectiles moves the active knives and returns to the pool the ones too far from the player.
